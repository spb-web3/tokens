...
deploy :;
	@forge script script/DeployOZERC20Token.s.sol:DeployOZERC20Token $(NETWORK_ARGS)

deploy_ocean :;
	@forge script script/blck_explr/DeployOceanToken.s.sol:DeployOceanToken $(NETWORK_ARGS)	
